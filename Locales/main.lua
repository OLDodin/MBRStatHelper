...
Locales["rus"]["desc"]="Производится расчет оптимального соотношения мастерства, беспощадности, решимости и удачи. Балансируются лишь те что уже вложены в указанные на текущий момент. Подбор господства, стремительности лежит на вас самих(они для каждого класса индивидуальны). Шаг рассчета 10 статов."
