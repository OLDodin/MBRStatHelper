...
Locales["rus"]["calcButton"]="Посчитать"
Locales["rus"]["desc"]="Производится расчет оптимального соотношения мастерства, беспощадности, решимости и типов урона. Балансируются лишь те что уже вложены в указанные на текущий момент. Подбор силы крита, шанса крита, двойной атаки лежит на вас самих(они для каждого класса индивидуальны)."
...
Locales["rus"]["specialDesc"]="Укажите процентное соотношение ваших типов урона, шаг рассчета 10-15 статов. (Проведите тест на манекене без вложения каких либо очков в типы урона).  Если значения не указать учитываться они не будут."
